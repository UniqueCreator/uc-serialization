...
msbuild_generator.exe --input ..\dev\src\ --mode h >> build_h.msbuild
msbuild_generator.exe --input ..\dev\include\ --mode h >> build_h.msbuild
...
msbuild_generator.exe --input ..\dev\src\ --mode cpp >> build_cpp.msbuild
...
msbuild_generator.exe --type filters --input ..\dev\src\ --mode h >> build.vcxproj.filters
msbuild_generator.exe --type filters --input ..\dev\src\ --mode cpp >> build.vcxproj.filters
msbuild_generator.exe --type filters --input ..\dev\include\ --mode h >> build.vcxproj.filters
